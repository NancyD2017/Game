...
//        frame.add(new RoadButton("11_12",1237,848, 60));
    ...
    public void addCityOrTownButtons(JFrame frame) {
        frame.add(new RoundButton("1_1", 633, 123));
        frame.add(new RoundButton("1_3", 734,70));
        frame.add(new RoundButton("1_5", 839, 123));
        frame.add(new RoundButton("1_7", 925,70));
        frame.add(new RoundButton("1_9", 1023, 123));
        frame.add(new RoundButton("1_11", 1124,70));
        frame.add(new RoundButton("1_13", 1216, 123));
        ...
        frame.add(new RoundButton("7_3", 541, 633));
        frame.add(new RoundButton("7_5", 633, 571));
        frame.add(new RoundButton("7_7", 734, 633));
        frame.add(new RoundButton("7_9", 839,571));
        frame.add(new RoundButton("7_11", 925, 633));
        frame.add(new RoundButton("7_13", 1023,571));
        frame.add(new RoundButton("7_15", 1124, 633));
        frame.add(new RoundButton("7_17", 1216,571));
        frame.add(new RoundButton("7_19", 1318, 633));
